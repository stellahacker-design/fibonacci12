...
export const FINANCIAL_PRODUCTS = [
  { id: "espresso", name: "Specialty Espresso (Take Away)", price: 2.20, cost: 0.35, category: "coffee", dailySales: 40 },
  { id: "espresso-in", name: "Specialty Espresso (Dine In)", price: 3.50, cost: 0.35, category: "coffee", dailySales: 15 },
  { id: "freddo-espresso", name: "Freddo Espresso (Take Away)", price: 2.60, cost: 0.40, category: "coffee", dailySales: 35 },
  { id: "freddo-espresso-in", name: "Freddo Espresso (Dine In)", price: 4.00, cost: 0.40, category: "coffee", dailySales: 12 },
  { id: "cappuccino", name: "Freddo Cappuccino (Take Away)", price: 2.90, cost: 0.55, category: "coffee", dailySales: 30 },
  { id: "cappuccino-in", name: "Freddo Cappuccino (Dine In)", price: 4.50, cost: 0.55, category: "coffee", dailySales: 10 },
  { id: "filter-micro", name: "Filter Specialty Micro-lot (Dine In)", price: 4.80, cost: 0.70, category: "coffee", dailySales: 8 },
  { id: "vegan-muffin", name: "Handmade Vegan Muffin", price: 3.20, cost: 0.80, category: "snacks", dailySales: 15 },
  { id: "cookie-double", name: "Double Choc Urban Cookie", price: 2.50, cost: 0.60, category: "snacks", dailySales: 20 },
  { id: "craft-beer", name: "Local Craft Beer (Dine In)", price: 5.50, cost: 1.80, category: "beers", dailySales: 18 },
  { id: "specialty-cocktail", name: "Custom Street-Art Cocktail", price: 8.50, cost: 2.20, category: "cocktails", dailySales: 22 }
];
